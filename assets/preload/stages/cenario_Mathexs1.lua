function onCreate()
	...
	makeLuaSprite('ceu', 'backgrounds/Mathexs/dia1/ceu', 0, 100); 
	setLuaSpriteScrollFactor('ceu', 0.9, 0.9);
	scaleObject('ceu',1.8,1.5)
	
	makeLuaSprite('mth', 'backgrounds/Mathexs/dia1/Arbusto', 0, 100); 
	setLuaSpriteScrollFactor('mth', 0.9, 0.9);
	scaleObject('mth',1.8,1.5)
	
	makeLuaSprite('rua', 'backgrounds/Mathexs/dia1/rua', 0, 100);
	setLuaSpriteScrollFactor('rua', 0.9, 0.9);
	scaleObject('rua', 1.8, 1.5);
	
	makeLuaSprite('BOB', 'backgrounds/Mathexs/bob', -600, 330);
...
function onStepHit()
   ...
   doTweenX('BOB.x','BOB',2200,15,'sineout')   
   end
