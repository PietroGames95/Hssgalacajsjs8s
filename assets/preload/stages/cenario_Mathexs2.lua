function onCreate()
	...
	makeLuaSprite('ceu', 'backgrounds/Mathexs/dia2/ceu', 0, 100); 
	setLuaSpriteScrollFactor('ceu', 0.9, 0.9);
	scaleObject('ceu',1.8,1.5)
	
	makeLuaSprite('mth', 'backgrounds/Mathexs/dia2/Arbusto', 0, 100); 
	setLuaSpriteScrollFactor('mth', 0.9, 0.9);
	scaleObject('mth',1.8,1.5)
	
	makeLuaSprite('rua', 'backgrounds/Mathexs/dia2/rua', 0, 100);
	setLuaSpriteScrollFactor('rua', 0.9, 0.9);
	scaleObject('rua', 1.8, 1.5);
	
	makeLuaSprite('Universo', 'backgrounds/Mathexs/dia2/Universo', 0, 100); 
	setLuaSpriteScrollFactor('Universo', 0.9, 0.9);
	scaleObject('Universo',1.8,1.5)
	
	makeLuaSprite('Universo2', 'backgrounds/Mathexs/dia2/Universo2', 0, 100); 
